...
INSERT INTO directus_permissions VALUES(14,NULL,'profile','read','{}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(15,NULL,'grocery_items','create','{}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(27,'e821bb44-85aa-4153-9e6d-d03c65e871d5','profile','read','{"user":{"id":{"_eq":"$CURRENT_USER"}}}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(28,'e821bb44-85aa-4153-9e6d-d03c65e871d5','profile','create',NULL,'{"user":{"id":{"_eq":"$CURRENT_USER"}}}',NULL,NULL);
INSERT INTO directus_permissions VALUES(29,'e821bb44-85aa-4153-9e6d-d03c65e871d5','profile','update','{"user":{"id":{"_eq":"$CURRENT_USER"}}}',NULL,NULL,NULL);
INSERT INTO directus_permissions VALUES(30,'e821bb44-85aa-4153-9e6d-d03c65e871d5','profile','delete','{"user":{"id":{"_eq":"$CURRENT_USER"}}}',NULL,NULL,NULL);
INSERT INTO directus_permissions VALUES(31,'e821bb44-85aa-4153-9e6d-d03c65e871d5','profile','share','{"user":{"id":{"_eq":"$CURRENT_USER"}}}',NULL,NULL,NULL);
INSERT INTO directus_permissions VALUES(32,'e821bb44-85aa-4153-9e6d-d03c65e871d5','grocery_items','create','{}','{"profile":{"user":{"id":{"_eq":"$CURRENT_USER"}}}}',NULL,'*');
INSERT INTO directus_permissions VALUES(33,'e821bb44-85aa-4153-9e6d-d03c65e871d5','grocery_items','update','{"profile":{"user":{"id":{"_eq":"$CURRENT_USER"}}}}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(34,'e821bb44-85aa-4153-9e6d-d03c65e871d5','grocery_items','delete','{"profile":{"user":{"id":{"_eq":"$CURRENT_USER"}}}}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(35,'e821bb44-85aa-4153-9e6d-d03c65e871d5','grocery_items','share','{"profile":{"user":{"id":{"_eq":"$CURRENT_USER"}}}}','{}',NULL,'*');
INSERT INTO directus_permissions VALUES(36,'e821bb44-85aa-4153-9e6d-d03c65e871d5','grocery_items','read','{"profile":{"user":{"id":{"_eq":"$CURRENT_USER"}}}}','{}',NULL,'*');
...
INSERT INTO directus_users VALUES('c484ffcc-4aab-471a-9046-4bf2804b63ce',NULL,NULL,'admin@grapp.org','$argon2i$v=19$m=4096,t=3,p=1$ut5gENHhaWugOI6q3WPiLg$8j7VKYRdcQbYv1hdf2YJnrTqYfNNf5zBfNFy45SR+i0',NULL,NULL,NULL,NULL,NULL,'en-US','auto',NULL,'active','04faaa89-8546-4486-b492-10156cb5b6db',NULL,1641568706594,'/users/c484ffcc-4aab-471a-9046-4bf2804b63ce','default',NULL,NULL,1);
INSERT INTO directus_users VALUES('33eb64ec-a4b3-4221-b7e4-a915977d1148','Guy','Duchatelet','testuser@test.org','$argon2i$v=19$m=4096,t=3,p=1$DeGN+1NBdPgCSDQCAfhwFg$iiXt0+0tfBEaOcxOV5K62jsv78T9lGaPoMbNBRiyY8Q',NULL,NULL,NULL,NULL,NULL,'en-US','auto',NULL,'active','e821bb44-85aa-4153-9e6d-d03c65e871d5',NULL,1641569038989,'/users','default',NULL,NULL,1);
...
INSERT INTO directus_fields VALUES(1,'grocery_items','profile',NULL,'select-dropdown-m2o','{"template":"{{name}}{{user.email}}","filter":{"name":{"_contains":"u"}}}','related-values','{"template":"{{name}}"}',0,0,NULL,'full',NULL,NULL,NULL,0,NULL);
...
INSERT INTO directus_fields VALUES(31,'grocery_items','id',NULL,NULL,NULL,NULL,NULL,0,0,NULL,'full',NULL,NULL,NULL,0,NULL);
INSERT INTO directus_fields VALUES(32,'grocery_items','name',NULL,NULL,NULL,NULL,NULL,0,0,NULL,'full',NULL,NULL,NULL,0,NULL);
INSERT INTO directus_fields VALUES(33,'grocery_items','quantity',NULL,'input',NULL,'raw',NULL,0,0,NULL,'full',NULL,NULL,NULL,0,NULL);
INSERT INTO directus_fields VALUES(34,'grocery_items','unit',NULL,'input',NULL,'formatted-value',NULL,0,0,NULL,'full',NULL,NULL,NULL,0,NULL);
...
INSERT INTO directus_presets VALUES(1,NULL,'c484ffcc-4aab-471a-9046-4bf2804b63ce',NULL,'grocery_items',NULL,'tabular','{"tabular":{"page":1,"fields":["id","name","quantity","unit","profile"]}}',NULL,10,'{"profile":{"_eq":null}}');
...
INSERT INTO directus_presets VALUES(6,NULL,'33eb64ec-a4b3-4221-b7e4-a915977d1148',NULL,'grocery_items',NULL,NULL,'{"tabular":{"fields":["id","name","quantity","unit","profile"],"page":1}}',NULL,NULL,NULL);
INSERT INTO directus_presets VALUES(7,NULL,'33eb64ec-a4b3-4221-b7e4-a915977d1148',NULL,'profile',NULL,NULL,'{"tabular":{"page":1}}',NULL,NULL,NULL);
...
CREATE TABLE IF NOT EXISTS "profile" (`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL, `name` varchar(255) NULL DEFAULT null, `user` char(36) NULL, CONSTRAINT `profile_user_foreign` FOREIGN KEY (`user`) REFERENCES `directus_users` (`id`) ON DELETE SET NULL);
...
CREATE TABLE IF NOT EXISTS "grocery_items" (`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL, `name` varchar(255) NULL, `quantity` integer NULL, `unit` varchar(255) NULL, `profile` integer NULL, CONSTRAINT `grocery_items_profile_foreign` FOREIGN KEY (`profile`) REFERENCES `profile` (`id`) ON DELETE SET NULL);
INSERT INTO grocery_items VALUES(1,'name1', 1, 'unit1', 2);
INSERT INTO grocery_items VALUES(2,'name2', 2, 'unit2', 2);
INSERT INTO grocery_items VALUES(3,'name3', 3, 'unit3', 2);
INSERT INTO grocery_items VALUES(4,'name4', 4, 'unit4', 2);
INSERT INTO grocery_items VALUES(5,'name5', 5, 'unit5', 2);

DELETE FROM sqlite_sequence;
INSERT INTO sqlite_sequence VALUES('directus_activity',1210);
INSERT INTO sqlite_sequence VALUES('directus_relations',3);
INSERT INTO sqlite_sequence VALUES('directus_revisions',1087);
...
INSERT INTO sqlite_sequence VALUES('directus_fields',35);
INSERT INTO sqlite_sequence VALUES('directus_presets',8);
INSERT INTO sqlite_sequence VALUES('profile',14);
INSERT INTO sqlite_sequence VALUES('grocery_items',99);
